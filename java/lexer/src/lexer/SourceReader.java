...
*/
    public char read() throws IOException {
        if (isPriorEndLine) 
        {
            ...
            if (nextLine != null) 
            {   
                //ReadLine is the part of the Console output.
                //Therefore we ll increment and add the static lineNumber
                //variable of Token class/
                Token.lineNumber++;
                System.out.println(""+Token.lineNumber+" READLINE:   "+nextLine);
            }
